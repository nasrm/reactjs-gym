...
export default function ExerciseCard(props) {
  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-s4 bg-slate-950 sm:flex-wrap'>
        ...
        <button onClick={handleSetIncrement} className='flex flex-col p-2 rounder border border-[1.5px] duration-200 border-solid border-blue-900 hover:border-blue-600 w-full duration-200'>
            <h3 className='text-slate-400 test-sm capitalize'>Sets Completed</h3>
